% trainMLPBP_MI_P1_RNGSeed.m - Function to train MLP classifier
...
% 
% SYNTAX: [W1,W2,b1,b2] = trainMLPBP_MI_P1_RNGSeed(alpha, epochs);
%
function [W1,W2,b1,b2] = trainMLPBP_MI_P1_RNGSeed(alpha, epochs)
    ...
    title(['Training and Validation MSE vs Epoch (α=', num2str(alpha, '%.1e'), ', HP=', num2str(NUM_HIDDEN_NEURONS),')']);
    legend show;
    grid on;
